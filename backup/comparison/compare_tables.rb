...
# {
#   data: [
#     {id: 13, url_key: 'itsonus', content: "lala1"},
#     {id: 3, url_key: 'itsonus2', content: "lala2"},
#     {id: 6, url_key: 'itsonus3', content: "lala3"},
#     {id: 2, url_key: 'itsonus5', content: "lala5"},
#   ],
#   index: {"13"=>0, "3"=>1, "6"=>2, "2"=>3}
# }
# Return Value Shape:
# [
#   {
...
def get_databases_select_tag(type, database_name)
  conn = Database.initialize_db_conn(type, database_name)
  result = yield(conn)
...
post "/db_compare" do
  ...
  conn = Database.initialize_db_conn(type, database)
